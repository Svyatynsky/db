(() => {
    ...
    (() => {
        ...
        let menuPageBody = document.querySelector(".product-page-catalog__filter");
        function qweqwe() {
            if (document.querySelector(".filter-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu-page__burger")) {
                    bodyLockToggle();
        ...
        function initSliders() {
            if (document.querySelector(".mainscreen__slider")) new core(".mainscreen__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".product-page-slider__slider")) new core(".product-page-slider__slider", {
                ...
                thumbs: {
                    swiper: {
                        el: ".product-page-slider-thumbs__slider",
                        slidesPerView: 5
                    }
                },
                navigation: {
                    prevEl: ".product-page-slider__arrow_prev",
                    nextEl: ".product-page-slider__arrow_next"
                }
            });
            if (document.querySelector(".product-page-slider-thumbs__slider")) new core(".product-page-slider-thumbs__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
